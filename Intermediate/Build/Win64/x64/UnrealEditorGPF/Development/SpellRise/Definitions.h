...
#define UE_PROJECT_NAME SpellRise
#define UE_TARGET_NAME SpellRiseEditor
#define UE_MODULE_NAME "SpellRise"
...
#define SPELLRISE_API DLLEXPORT 
#define SPELLRISE_NON_ATTRIBUTED_API DLLEXPORT
